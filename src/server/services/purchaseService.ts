/**
 * @file purchaseService.ts (Server Backend)
 * @description Capa de Servicio / Lógica de Negocio para Proveedores y Compras.
 */
...
export const purchaseService = {
  ...
  async upsertSupplier(s: Supplier): Promise<void> {
    if (!s.name) throw new Error('Nombre de proveedor obligatorio');
